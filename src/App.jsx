...
const Portfolio = () => {
  ...
  const metaFramework = [
    { axis: 'Observers', insight: 'Who sees the system? What lens do they use?' },
    { axis: 'Time', insight: 'How does behavior evolve? What triggers change?' },
    { axis: 'Wrongness', insight: 'Where can failures occur? What remains uncertain?' },
    { axis: 'Pressure', insight: 'What forces shape decisions? What constraints exist?' }
  ];

  const experience = [
    { company: 'Microsoft', role: 'Principal Engineer', years: 'Building at scale' },
    { company: 'Target', role: 'Principal Engineer', years: 'Retail systems' },
    { company: 'Intuit', role: 'Principal Engineer', years: 'Financial tech' },
    { company: 'Lowe\'s', role: 'Principal Engineer', years: 'Enterprise systems' }
  ];
  ...
  const earlierRoles = [
    { role: 'Chief Architect', company: 'Veloz Software', period: '2008 – 2011' },
    { role: 'Solution Architect', company: 'Zensar Technologies', period: '2005 – 2008' },
    { role: 'Senior Software Engineer', company: 'Integral Development Corp', period: '2002 – 2005' },
    { role: 'Software Engineer', company: 'Infozech Software', period: '2000 – 2002' }
  ];

  const talksAndPublications = [
    { title: 'Distributed Systems: A Finer Perspective', type: 'Talk', description: 'Advanced concepts and nuanced considerations in distributed systems design' },
    { title: 'Performance Engineering Methodologies', type: 'Talk', description: 'Effective methodologies for understanding and optimizing system performance' },
    { title: 'Challenges in Driving Innovation in Organizations', type: 'Talk', description: 'Obstacles and strategies for fostering innovation within corporate environments' },
    { title: 'Chain Replication in Distributed Databases', type: 'Talk', description: 'Practical application of chain replication techniques' },
    { title: 'Go The Other Way', type: 'Book', description: 'A pragmatic approach to learning the Go programming language' },
    { title: 'Houston, We Have A Problem', type: 'Book', description: 'A fictional tale of software systems, and the people they break' }
  ];

  const keySkillsCategories = [
    {
      category: 'System Architecture & Design',
      skills: ['Distributed Systems', 'Evolutionary Architecture', 'Domain-Driven Design', 'Event Sourcing', 'CQRS', 'Microservices', 'Platform Engineering']
    },
    {
      category: 'System Comprehension',
      skills: ['Codebase Navigation', 'Modular Reasoning', 'Complexity Management', 'Technical Debt Reduction', 'Performance Engineering']
    },
    {
      category: 'Security & Reliability',
      skills: ['Bot/DDoS Mitigation', 'Probabilistic Data Structures', 'System Reliability', 'Security at Scale']
    }
  ];
  ...
  const ventures = [
    {
      ...
      description: 'Advanced engineering education through first-principles thinking. Not pattern memorization—systematic understanding.',
      highlight: '100+ engineers transformed'
    },
    {
      name: 'FocusCircle',
      tagline: 'Deep work, together',
      description: 'Focus accountability platform using virtual coin mechanics and live work sessions.',
  ...
  const specflowFeatures = [
    {
      ...
      description: 'Formal specification generation with type system, link database, and module architecture',
      icon: '◈'
    },
    {
      title: 'Cold-Start & Drift Detection',
      description: 'Detect unspecified code and spec drift—ensure AI changes remain spec-consistent',
      icon: '◇'
    },
    {
      title: 'MCP Server Integration',
      description: 'Embedded JSON-RPC 2.0 server enabling deep integration with Claude Code, Cursor, and AI environments',
      icon: '○'
    },
    {
      title: 'LLM Proxy & Orchestration',
      description: '5-layer validation with SSE streaming—protects API keys, enforces limits in real-time',
      icon: '◆'
    },
    {
      title: 'License & Tier Management',
      description: 'Server-authoritative validation with tiered plans, usage tracking, and cost control',
      icon: '◈'
    },
    {
      title: 'Multi-Platform Distribution',
      description: 'Homebrew, Chocolatey, GitHub Releases with automated CI/CD builds for macOS, Linux, Windows',
      icon: '◇'
    }
  ];
  ...
  const featuredArticles = [
    {
      ...
      excerpt: 'All system design problems reduce to managing how time, wrongness, and pressure are perceived by their observers.',
    ...
    },
    {
      ...
      excerpt: 'The better you get at pattern-matching system design answers, the worse you get at actually designing systems.',
      category: 'philosophy',
      date: 'Dec 2025',
    ...
    },
    {
      ...
      excerpt: "Martin Fowler's definition has guided engineers for decades. It's clean, safe, and also incomplete.",
  ...
  const recentArticles = [
    ...
    },
    {
      ...
      excerpt: "Pressure is the rate at which expectations are created relative to the system's ability to resolve wrongness.",
      category: 'system-design',
      date: 'Dec 2025',
    ...
    },
    {
      ...
      excerpt: 'The distance between what an observer expected and what they encountered.',
      category: 'system-design',
      date: 'Dec 2025',
    ...
    },
    {
      ...
      excerpt: 'Everything traces back to bugs. Strip away the methodologies, and two problems remain.',
      category: 'philosophy',
      date: 'Nov 2025',
    ...
    },
    {
      ...
      excerpt: 'Clean Code, Pragmatic Programmer, Design Patterns—excellent advice that fails at scale.',
      category: 'philosophy',
      date: 'Nov 2025',
    ...
    },
    {
      ...
      excerpt: 'We learned preconditions and postconditions. Then we forgot them entirely.',
      category: 'practice',
      date: 'Oct 2025',
    ...
    },
    {
      ...
      excerpt: 'The kata has been solved thousands of times. Something profound is being missed.',
      category: 'refactoring',
      date: 'Oct 2025',
    ...
    },
    {
      ...
      excerpt: 'Everyone focuses on eliminating if statements. The kata teaches something deeper.',
      category: 'refactoring',
      date: 'Oct 2025',
    ...
    },
    {
      ...
      excerpt: 'How foundational principles reveal both excellence and pathology in real code.',
      category: 'refactoring',
      date: 'Oct 2025',
    ...
    },
    {
      ...
      excerpt: 'Going further than polymorphism—value objects, type-driven design, and MIRO principles.',
      category: 'refactoring',
      date: 'Oct 2025',
    ...
    },
    {
      ...
      excerpt: 'Three components functioning correctly. One catastrophic interaction.',
      category: 'practice',
      date: 'Oct 2025',
    ...
    },
    {
      ...
      excerpt: 'Thinking rituals that actually work—beyond glorified autocomplete.',
      category: 'practice',
      date: 'Nov 2025',
  ...
  return (
    <div className="min-h-screen bg-stone-950 text-stone-100 overflow-x-hidden" style={{ fontFamily: "'Crimson Pro', Georgia, serif" }}>
      {/* Grain overlay */}
      <div 
      ...
      {/* Navigation */}
      <nav className={`fixed top-0 left-0 right-0 z-40 px-8 py-6 flex justify-between items-center transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-4'}`}>
        <div className="text-lg tracking-widest font-light" style={{ fontFamily: "'Space Mono', monospace" }}>
          MANEESH
        </div>
        <div className="flex gap-8 text-sm tracking-wider text-stone-400" style={{ fontFamily: "'Space Mono', monospace" }}>
          <a href="#experience" className="hover:text-amber-400 transition-colors duration-300">Experience</a>
          <a href="#frameworks" className="hover:text-amber-400 transition-colors duration-300">Frameworks</a>
          <a href="#writing" className="hover:text-amber-400 transition-colors duration-300">Writing</a>
          <a href="#specflow" className="hover:text-amber-400 transition-colors duration-300">SpecFlow</a>
          <a href="#ventures" className="hover:text-amber-400 transition-colors duration-300">Ventures</a>
          <a href="#connect" className="hover:text-amber-400 transition-colors duration-300">Connect</a>
        </div>
      </nav>
      ...
      <section className="min-h-screen flex items-center relative px-8 lg:px-16">
        <div className="absolute top-0 right-0 w-1/2 h-full opacity-10">
          <div className="absolute inset-0" style={{
            background: 'radial-gradient(ellipse at 70% 30%, rgba(251, 191, 36, 0.4) 0%, transparent 60%)'
          }} />
        </div>
        
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center pt-24">
          <div className={`transition-all duration-1000 delay-300 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <p className="text-amber-400 tracking-widest text-sm mb-6 uppercase" style={{ fontFamily: "'Space Mono', monospace" }}>
            ...
            <p className="text-xl text-stone-400 leading-relaxed max-w-lg">
              The industry teaches pattern memorization. I teach systematic thinking. 
              The difference? Engineers who understand <em className="text-stone-200 not-italic">why</em>, 
              not just <em className="text-stone-200 not-italic">how</em>.
            </p>
          </div>

          <div className={`transition-all duration-1000 delay-500 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'}`}>
            <div className="relative">
              <div className="absolute -inset-4 border border-stone-800" style={{ transform: 'rotate(3deg)' }} />
              <div className="bg-stone-900 p-8 relative">
                <p className="text-stone-500 text-sm tracking-wider mb-4 uppercase" style={{ fontFamily: "'Space Mono', monospace" }}>
                  From the notebook
                </p>
                <blockquote className="text-2xl leading-relaxed italic text-stone-300">
                  "Real understanding isn't about recognizing patterns—it's about seeing 
                  the forces that create them."
                </blockquote>
                <div className="mt-6 flex items-center gap-4">
                  <div className="w-12 h-px bg-amber-400" />
                  <span className="text-stone-500 text-sm">Silent Worker Philosophy</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className={`absolute bottom-12 left-1/2 -translate-x-1/2 transition-all duration-1000 delay-700 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
      ...
      <section className="py-16 border-y border-stone-800 overflow-hidden">
        <div className={`flex items-center justify-center gap-16 text-stone-500 transition-all duration-1000 delay-700 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
          {experience.map((exp, i) => (
            <div key={i} className="flex items-center gap-4 group">
              <span className="text-2xl font-light text-stone-300 group-hover:text-amber-400 transition-colors duration-300">
                {exp.company}
              </span>
              <span className="text-xs tracking-wider uppercase hidden lg:block" style={{ fontFamily: "'Space Mono', monospace" }}>
                {exp.role}
              </span>
            </div>
          ))}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-3 gap-2 mb-16">
            <div className="lg:col-span-1">
              <p className="text-amber-400 tracking-widest text-sm mb-4 uppercase" style={{ fontFamily: "'Space Mono', monospace" }}>
                Career Journey
              </p>
            </div>
            <div className="lg:col-span-2">
              <h2 className="text-4xl lg:text-5xl font-light leading-tight">
                25+ years of building<br />systems that last
              </h2>
            </div>
          </div>
          ...
          <div className="space-y-12">
            {detailedExperience.map((job, i) => (
              <div key={i} className="group grid lg:grid-cols-12 gap-8 pb-12 border-b border-stone-800/50 last:border-0">
                ...
                <div className="lg:col-span-4">
                  <div className="lg:sticky lg:top-32">
                    ...
                    <p className="text-amber-400 text-sm mb-1" style={{ fontFamily: "'Space Mono', monospace" }}>
                      {job.role}
                    </p>
                    <p className="text-stone-500 text-sm mb-1">{job.team}</p>
                    <p className="text-stone-600 text-xs" style={{ fontFamily: "'Space Mono', monospace" }}>
                ...
                <div className="lg:col-span-8">
                  <ul className="space-y-4">
                    {job.highlights.map((highlight, j) => (
                      <li key={j} className="flex gap-4 text-stone-400 leading-relaxed">
          ...
          <div className="mt-16 pt-16 border-t border-stone-800">
            <p className="text-xs text-stone-600 tracking-widest uppercase mb-6" style={{ fontFamily: "'Space Mono', monospace" }}>
            ...
            <div className="flex flex-wrap gap-6">
              {earlierRoles.map((role, i) => (
                <div key={i} className="group">
                  ...
                  <span className="text-stone-700 text-xs ml-2" style={{ fontFamily: "'Space Mono', monospace" }}>
                    {role.period}
                  </span>
                </div>
              ))}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {frameworks.map((fw, i) => (
              ...
              >
                <div className={`absolute inset-0 border transition-all duration-500 ${hoveredFramework === i ? 'border-amber-400 scale-105' : 'border-stone-800'}`} 
                     style={{ transform: hoveredFramework === i ? 'rotate(-1deg)' : 'rotate(0deg)' }} />
                <div className="relative bg-stone-900 p-8 h-full transition-transform duration-500 group-hover:-translate-y-2">
                  <div className="text-5xl text-amber-400 mb-6 opacity-60">{fw.icon}</div>
                  <h3 className="text-2xl font-light mb-4">{fw.name}</h3>
                  <p className="text-stone-400 leading-relaxed mb-6">{fw.description}</p>
                  <div className="pt-6 border-t border-stone-800">
                    <span className="text-sm text-amber-400 tracking-wider" style={{ fontFamily: "'Space Mono', monospace" }}>
                      {fw.metric}
                    </span>
                  </div>
                </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <h2 className="text-4xl lg:text-5xl font-light leading-tight mb-8">
                Four Axes of<br />Software Design
              </h2>
              <p className="text-stone-400 text-lg leading-relaxed">
                Every system can be understood through these four lenses. 
                Master them, and complexity becomes navigable.
              </p>
            </div>
              ...
              {metaFramework.map((item, i) => (
                ...
                >
                  <div className="flex items-baseline gap-4 mb-2">
                    <span className="text-xs text-stone-600" style={{ fontFamily: "'Space Mono', monospace" }}>
                      0{i + 1}
                    </span>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-stone-400 max-w-2xl mx-auto">
              Deep dives into system design, refactoring wisdom, and the philosophy of software craftsmanship.
            </p>
          </div>
          ...
          <div className="mb-20">
            <div className="flex items-center gap-4 mb-8">
              <span className="text-xs text-amber-400 tracking-widest uppercase" style={{ fontFamily: "'Space Mono', monospace" }}>Featured</span>
                ...
                >
                  ...
                  <div className="relative border border-stone-800 p-8 h-full bg-stone-950 group-hover:border-amber-400/50 transition-all duration-300">
                    <div className="flex items-center gap-3 mb-4">
                      <span className="text-xs px-2 py-1 bg-stone-800 text-stone-400 uppercase tracking-wider" style={{ fontFamily: "'Space Mono', monospace" }}>
                    ...
                    <div className="mt-6 flex items-center gap-2 text-amber-400 text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300" style={{ fontFamily: "'Space Mono', monospace" }}>
                      <span>Read</span>
                      <span>→</span>
                    </div>
                  </div>
          ...
          <div className="flex items-center gap-4 mb-8 overflow-x-auto pb-4">
            <span className="text-xs text-stone-600 tracking-widest uppercase shrink-0" style={{ fontFamily: "'Space Mono', monospace" }}>Filter:</span>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-3 mb-2">
                    <span className="text-xs text-stone-600 uppercase tracking-wider" style={{ fontFamily: "'Space Mono', monospace" }}>
                      {article.category.replace('-', ' ')}
                    </span>
          ...
          <div className="grid lg:grid-cols-2 gap-16 mb-20">
            <div>
              ...
              <p className="text-xl text-stone-400 leading-relaxed mb-6">
                An AI-powered, specification-driven development platform enabling safe AI-assisted changes on large codebases. 
                Built as a distributed client-server system with a cross-platform CLI (~14K LOC Go, 21 internal modules) 
                and embedded MCP server for deep integration with Claude Code, Cursor, and AI coding environments.
              </p>
              <div className="flex flex-wrap gap-3 mb-6">
                {['Go', 'PostgreSQL', 'OpenAI', 'MCP', 'Razorpay', 'SSE Streaming'].map((tag, i) => (
                  <span 
                    key={i}
            ...
            <div className="relative">
              <div className="absolute -inset-4 border border-stone-800 opacity-50" style={{ transform: 'rotate(-1deg)' }} />
              <div className="relative bg-stone-950 p-6 border border-stone-800">
                <p className="text-xs text-stone-600 tracking-widest uppercase mb-4" style={{ fontFamily: "'Space Mono', monospace" }}>
                  Architecture
                </p>
                <pre className="text-xs text-stone-500 leading-relaxed overflow-x-auto" style={{ fontFamily: "'Space Mono', monospace" }}>
{`┌─────────────────────────────────┐
...
└─────────────────────────────────┘
    ...
    PostgreSQL (Supabase)`}
          ...
          <div className="mb-20">
            <div className="flex items-center gap-4 mb-8">
              <span className="text-xs text-amber-400 tracking-widest uppercase" style={{ fontFamily: "'Space Mono', monospace" }}>Tier System</span>
              <div className="flex-1 h-px bg-stone-800" />
            </div>
            
            <div className="grid lg:grid-cols-3 gap-6">
              {[
                { tier: 'FREE', price: '₹0', ops: '20', tokens: '10K', model: 'gpt-4o-mini' },
                { tier: 'PRO', price: '₹1,999/mo', ops: '550', tokens: '2M', model: 'gpt-4o' },
                { tier: 'PREMIUM', price: '₹6,999/mo', ops: '3,300', tokens: '10M', model: 'gpt-4o' }
              ].map((plan, i) => (
                <div 
                  key={i}
                ...
                >
                  <div className="flex items-baseline justify-between mb-4">
                    ...
                    <span className="text-amber-400 text-sm" style={{ fontFamily: "'Space Mono', monospace" }}>{plan.price}</span>
                  </div>
          ...
          <div className="mb-20">
            <div className="flex items-center gap-4 mb-8">
              <span className="text-xs text-amber-400 tracking-widest uppercase" style={{ fontFamily: "'Space Mono', monospace" }}>Core Capabilities</span>
              <div className="flex-1 h-px bg-stone-800" />
            </div>
            
            <div className="grid lg:grid-cols-3 gap-6">
              {specflowFeatures.map((feature, i) => (
                <div key={i} className="group flex gap-6 p-6 border border-stone-800/50 hover:border-stone-700 transition-all duration-300">
          ...
          <div className="mb-20">
            <div className="flex items-center gap-4 mb-8">
              <span className="text-xs text-amber-400 tracking-widest uppercase" style={{ fontFamily: "'Space Mono', monospace" }}>LLM Proxy: 5-Layer Validation</span>
              <div className="flex-1 h-px bg-stone-800" />
            </div>
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              {[
                ...
                <div key={i} className="flex items-center gap-3">
                  <span className="w-8 h-8 flex items-center justify-center text-xs bg-stone-800 text-amber-400" style={{ fontFamily: "'Space Mono', monospace" }}>
                    {i + 1}
                  </span>
          ...
          <div>
            <div className="flex items-center gap-4 mb-8">
              <span className="text-xs text-amber-400 tracking-widest uppercase" style={{ fontFamily: "'Space Mono', monospace" }}>Tech Stack</span>
              <div className="flex-1 h-px bg-stone-800" />
            </div>
            
            <div className="flex flex-wrap gap-4 justify-center">
              {specflowTechStack.map((tech, i) => (
                <div key={i} className="group px-4 py-3 border border-stone-800 hover:border-stone-700 transition-all duration-300">
                  <span className="text-stone-300 text-sm">{tech.name}</span>
                  <span className="text-stone-600 text-xs ml-2" style={{ fontFamily: "'Space Mono', monospace" }}>
                    {tech.category}
                  </span>
                </div>
              ))}
      ...
      <section id="ventures" className="py-32 px-8 lg:px-16">
        <div className="max-w-6xl mx-auto">
          <p className="text-amber-400 tracking-widest text-sm mb-4 uppercase text-center" style={{ fontFamily: "'Space Mono', monospace" }}>
            Current Ventures
          </p>
              ...
              <div key={i} className="group relative">
                ...
                <div className="relative border border-stone-800 p-10 h-full bg-stone-950 group-hover:border-stone-700 transition-colors duration-300">
                  <div className="flex items-start justify-between mb-6">
                    <div>
                      <h3 className="text-2xl font-light mb-2">{venture.name}</h3>
                      <p className="text-amber-400 text-sm italic">{venture.tagline}</p>
                    </div>
                  ...
                  <div className="pt-6 border-t border-stone-800">
                    <span className="text-sm tracking-wider text-stone-500" style={{ fontFamily: "'Space Mono', monospace" }}>
                      {venture.highlight}
                    </span>
                  </div>
                </div>
      ...
      <section className="py-32 px-8 lg:px-16 bg-gradient-to-b from-stone-900/50 to-stone-950">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-stone-400 leading-relaxed max-w-2xl mx-auto mb-12">
            A book about self-knowledge and identity—moving beyond traditional labels 
            to observe oneself through behavioral patterns.
          </p>
          <div className="inline-flex items-center gap-4 text-stone-500 text-sm" style={{ fontFamily: "'Space Mono', monospace" }}>
            ...
            <div className="grid lg:grid-cols-3 gap-8 items-center">
              <div className="lg:col-span-2">
                ...
                <p className="text-stone-400 leading-relaxed">
                  Exploring why traditional notions of "software engineering" break down under modern scale, 
                  complexity, and AI-assisted development. A shift from implementation-centric thinking to 
      ...
      <section className="py-24 px-8 lg:px-16 bg-stone-900/30">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl lg:text-4xl font-light">Core Competencies</h2>
          </div>

          <div className="grid lg:grid-cols-3 gap-8">
            {keySkillsCategories.map((cat, i) => (
              <div key={i} className="text-center">
                <h4 className="text-sm text-amber-400 tracking-wider uppercase mb-4" style={{ fontFamily: "'Space Mono', monospace" }}>
                  {cat.category}
                </h4>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            {[
              ...
              <div key={i} className="group">
                ...
                <div className="text-sm text-stone-500 tracking-wider uppercase" style={{ fontFamily: "'Space Mono', monospace" }}>
                  {stat.label}
                </div>
              </div>
            ))}
      ...
      <section id="connect" className="py-32 px-8 lg:px-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-4xl lg:text-5xl font-light leading-tight mb-8">
            Ready to think differently<br />about software?
          </h2>
          <p className="text-xl text-stone-400 leading-relaxed mb-12">
            Whether you're looking to transform your engineering team or deepen your own practice—
      ...
      <footer className="py-12 px-8 lg:px-16 border-t border-stone-800">
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-6">
          <div className="text-stone-600 text-sm" style={{ fontFamily: "'Space Mono', monospace" }}>
            © 2025 Maneesh · Bangalore, India
          </div>
          <div className="flex items-center gap-8 text-stone-500 text-sm" style={{ fontFamily: "'Space Mono', monospace" }}>
            <a href="#" className="hover:text-amber-400 transition-colors duration-300">LinkedIn</a>
            <a href="#" className="hover:text-amber-400 transition-colors duration-300">GitHub</a>
